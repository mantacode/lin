...
/**
  ...
  *  options
  ...
  var api = Lini.api('v1','newsAPI','topNews',{});
*/
...
/**
  ...
  *  options
  ...
  example:
  var Lini = require('lini');
  var api = Lini.api('v1','newsAPI','sharedNews',{});
*/
...
/**
  ...
  *  options
  ...
  example:
  var Lini = require('lini');
  var api = Lini.api('v1','newsAPI','topicNews','eyJicmVlZCI6IlRvcCIsImFsaWFzIjoiVE9QX1NMSUNFX05FV1NfVE9EQVkgMjgiLCJwZXJpb2QiOiJEYXkiLCJlbnRpdGllcyI6WyJJTkRZXzI4Il19', {});
*/
...
/**
  ...
  *  options
  ...
  example:
  var Lini = require('lini');
  var api = Lini.api('v1','newsAPI','followedTopics', {count:10});
*/
...
/**
  ...
  *  options:
  ...
  example:
  var Lini = require('lini');
  var api = Lini.api('v1','newsAPI','article', 5562792952759058434, {fields:":(is-read,when-saved,article-content)"});
*/
...
/**
  ...
  *  options:
  ...
  example:
  var Lini = require('lini');
  var api = Lini.api('v1','newsAPI','shares', 5562792952759058434, {count:5});
*/

...
/**
  ...
  *  options:
  ...
  var api = Lini.api('v1','updatesAPI','updates',{count:10});
*/
...
/**
  ...
  *  options:
  ...
  example:
  var Lini = require('lini');
  var api = Lini.api('v1','updatesAPI','likes',"UNIU-15003820-5563047074699685888-SHARE",{count:5});
*/
...
/**
  ...
  *  options:
  ...
  example:
  var Lini = require('lini');
  var api = Lini.api('v1','updatesAPI','comments',"UNIU-15003820-5563047074699685888-SHARE",{count:5});
*/
...
/**
  ...
  *  doLike:  true (or undefined) if liking, false if unliking
  ...
  example:
  var Lini = require('lini');
  var api = Lini.api('v1','updatesAPI','like',"UNIU-15003820-5563047074699685888-SHARE");
...
/**
  ...
  *  comment:  comment
  ...
  example:
  var Lini = require('lini');
  var api = Lini.api('v1','updatesAPI','comment',"UNIU-15003820-5563047074699685888-SHARE", "This is so cool!");
*/
...
/**
  ...
  *  options:
  ...
  example:
  var Lini = require('lini');
  var api = Lini.api('v1','updatesAPI','share',{comment:"simple status update"});
  var api = Lini.api('v1','updatesAPI','share',{contentTitle:"What You Can Learn", contentUrl:"http://www.linkedin.com/today/article?articleID=5562792952759058434&trk=tod-home-art", comment:"set your alarm clocks"});
*/

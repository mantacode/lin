...
/**
  ...
  *  options:
  ...
  var api = Lini.api('v1','peopleAPI','profile', {id:"15003820", authToken:'NAME:Yc02'});
*/
...
/**
  ...
  *  options:
  ...
  example:
  var Lini = require('lini');
  var api = Lini.api('v1','peopleAPI','connections', {id:"15003820"});
*/
 ...
 *  options:
   ...
   example:
   var Lini = require('lini');
   var api = Lini.api('v1','peopleAPI','search', {keywords:"Alex Zoff"});
*/

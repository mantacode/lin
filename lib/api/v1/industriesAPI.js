...
/**
  ...
  *  options
  ...
  var api = Lini.api('v1','industriesAPI','followed',{count:25});
*/
...
/**
  ...
  *  id: industry id
  ...
  example:
  var Lini = require('lini');
  var api = Lini.api('v1','industriesAPI','follow',6);
*/
function follow(id) {
...
/**
  ...
  *  id: industry id
  ...
  example:
  var Lini = require('lini');
  var api = Lini.api('v1','industriesAPI','unfollow',6);
*/
...
/**
  ...
  *  options
   ...
   example:
   var Lini = require('lini');
   var api = Lini.api('v1','industriesAPI','preview',6, {maxStories:10});
*/
...
/**
  ...
  *  industryId:  eg: 6
  ...
  example:
  var Lini = require('lini');
  var api = Lini.api('v1','industriesAPI','industryName',6);
*/
